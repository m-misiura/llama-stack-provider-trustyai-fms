...
class DetectorProvider(Safety, Shields):
    ...
    def _get_openai_category_if_confident(self, shield_id: str) -> str | None:
        ...
        # Comprehensive mapping for all 13 OpenAI categories using ACTUAL enum values
        confident_mappings = {
            # Violence categories
            ...
            # Harassment categories (note the typo in upstream: HARRASMENT)
            'harassment': OpenAICategories.HARRASMENT.value,  # "harassment" 
            'harass': OpenAICategories.HARRASMENT.value,
            'bully': OpenAICategories.HARRASMENT.value,
            'harassment_threatening': OpenAICategories.HARRASMENT_THREATENING.value,  # "harassment/threatening"
            'threatening_harassment': OpenAICategories.HARRASMENT_THREATENING.value,
            'threat': OpenAICategories.HARRASMENT_THREATENING.value,
